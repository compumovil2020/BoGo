  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      theme: ThemeData(
        ...
        // is not restarted.
        primarySwatch: CustomColors.createMaterialColor(CustomColors.BogoRed),
...
class _MyHomePageState extends State<MyHomePage> {
  TextEditingController tecCorreo, tecPassword;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      key: _scaffoldKey,
      backgroundColor: CustomColors.createMaterialColor(CustomColors.BackgroundColor),
      body: Padding(
